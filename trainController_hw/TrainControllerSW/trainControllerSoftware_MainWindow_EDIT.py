...
class Ui_TrainControllerSW_MainWindow(object):
    def setupUi(self, TrainControllerSW_MainWindow):
        ...
        self.label_5.setGeometry(QtCore.QRect(540, 120, 121, 41))
        font = QtGui.QFont()
        ...
        self.Manual_temperature_box.setMinimum(50.0)
        self.Manual_temperature_box.setMaximum(90.0)
        self.Manual_temperature_box.setProperty("value", 72.0)
        ...
        self.OpenTestUI.setGeometry(QtCore.QRect(720, 370, 93, 29))
        self.OpenTestUI.setObjectName("OpenTestUI")
        self.label_17 = QtWidgets.QLabel(self.centralwidget)
        self.label_17.setGeometry(QtCore.QRect(540, 80, 111, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.faultsframe.setGeometry(QtCore.QRect(550, 240, 111, 151))
        ...
        self.next_station_label.setGeometry(QtCore.QRect(710, 130, 111, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_26.setGeometry(QtCore.QRect(560, 170, 161, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.PowerOutput_lcdDisplay.setGeometry(QtCore.QRect(740, 170, 71, 41))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.frame.setGeometry(QtCore.QRect(690, 240, 111, 41))
        ...
        self.OpenTestUI_2 = QtWidgets.QPushButton(self.centralwidget)
        self.OpenTestUI_2.setGeometry(QtCore.QRect(720, 330, 93, 29))
        self.OpenTestUI_2.setObjectName("OpenTestUI_2")
        self.DisplayPower = QtWidgets.QPushButton(self.centralwidget)
        self.DisplayPower.setGeometry(QtCore.QRect(720, 290, 93, 29))
    ...
    def retranslateUi(self, TrainControllerSW_MainWindow):
        ...
        self.label_17.setText(_translate("TrainControllerSW_MainWindow", "Authority:"))
        ...
        self.OpenTestUI_2.setText(_translate("TrainControllerSW_MainWindow", "Open Test UI"))
