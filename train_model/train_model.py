...
class DisplayWorker(QObject):
    ...
    def run(self):
        ...
        while True:
            ...
            if self.qt.t.curr_speed is None:
                speed = self.qt.t.get_speed()
                self.qt.curr_speed_disp.setText(f'{speed} mph')
            else:
                self.qt.curr_speed_disp.setText(f'{self.qt.t.curr_speed} mph')
