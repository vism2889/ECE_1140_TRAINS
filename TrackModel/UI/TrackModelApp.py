...
class TrackModel(QWidget):
    ...
    def __init__(self, signals=None):
        ...
        # self.occupancy            = [False for i in range(150)] # only Green line for right now
        # self.faults               = [0 for i in range(150)]     # only Green line for right now
