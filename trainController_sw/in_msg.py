...
class in_msg(msg):
	...
	def serialize(self):
		...
		self.__vars__[9] = self.internal_light_command
		self.__vars__[10] = self.external_light_command
		self.__vars__[5] = self.announce_command
	...
	def deserialize(self, buffer):
		...
		self.internal_light_command = self.__vars__[9]
		self.external_light_command = self.__vars__[10]
		self.announce_command = self.__vars__[5]
