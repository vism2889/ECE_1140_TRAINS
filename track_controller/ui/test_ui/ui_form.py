...
class Ui_test_window(object):
    def setupUi(self, test_window):
        ...
        self.toggle_occupancy.clicked.connect(self.toggleOccupancy())
        ...
        self.toggle_crossing.clicked.connect(self.toggleCrossing())
        ...
        self.toggle_switch.clicked.connect(self.toggle_switch())
        ...
        self.toggle_maintenance.clicked.connect(self.toggleMaintenance())
        ...
        self.broken_rail.clicked.connect(self.setFaults())
        ...
        self.circuilt_failure.clicked.connect(self.setFaults())
        ...
        self.power_failure.clicked.setObjectName(u"power_failure")
